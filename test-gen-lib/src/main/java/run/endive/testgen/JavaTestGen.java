...
public class JavaTestGen {
    ...
    public CompilationUnit generate(String name, Wast wast, String wasmClasspath) {
        var cu = new CompilationUnit("run.endive.test.gen");
        var testName =
        ...
        // testing imports
        cu.addImport("run.endive.testing.TestModule");
        ...
        // base imports
        cu.addImport("run.endive.wasm.InvalidException");
        cu.addImport("run.endive.wasm.MalformedException");
        cu.addImport("run.endive.wasm.UninstantiableException");
        cu.addImport("run.endive.wasm.UnlinkableException");
        cu.addImport("run.endive.wasm.types.Value");

        cu.addImport("run.endive.wasm.types.Value.REF_NULL_VALUE", true, false);
        cu.addImport("run.endive.wasm.types.Value.vecTo8", true, false);
        cu.addImport("run.endive.wasm.types.Value.vecTo16", true, false);
        cu.addImport("run.endive.wasm.types.Value.vecTo32", true, false);
        cu.addImport("run.endive.wasm.types.Value.vecToF32", true, false);
        cu.addImport("run.endive.wasm.types.Value.vecToF64", true, false);

        cu.addImport("run.endive.wasm.types.Value.i8ToVec", true, false);
        cu.addImport("run.endive.wasm.types.Value.i16ToVec", true, false);
        cu.addImport("run.endive.wasm.types.Value.i32ToVec", true, false);
        cu.addImport("run.endive.wasm.types.Value.i64ToVec", true, false);
        cu.addImport("run.endive.wasm.types.Value.f64ToVec", true, false);
        cu.addImport("run.endive.wasm.types.Value.f32ToVec", true, false);

        // import for Store instance
        cu.addImport("run.endive.runtime.Store");
        // import for shared Spectest host module
        cu.addImport("run.endive.testing.Spectest");
