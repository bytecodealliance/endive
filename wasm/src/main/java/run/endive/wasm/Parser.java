...
import static run.endive.wasm.Encoding.readFloat64;
import static run.endive.wasm.Encoding.readName;
import static run.endive.wasm.Encoding.readVarSInt32;
import static run.endive.wasm.Encoding.readVarSInt64;
...
import run.endive.wasm.types.DataSection;
import run.endive.wasm.types.DeclarativeElement;
import run.endive.wasm.types.Element;
import run.endive.wasm.types.ElementSection;
...
import run.endive.wasm.types.StartSection;
...
public final class Parser {
    private static final String DIGEST_ALGORITHM =
            System.getProperty("run.endive.wasm.Parser.DIGEST_ALGORITHM", "SHA-256");
